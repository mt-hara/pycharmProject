class ExcelSheetDTO():
    def __init__(self, ws):
        ...
        self.__xlBranchOfficeAddress: str = self.celldata(ws.rangeq("H11").value, str)  # H11
        ...
        self.__xlRepName: str = str(ws.range("H14").value)  # H14
        self.__xlRepKanaName: str = str(ws.range("H13").value)  # H13
        self.__xlRepJobTitle: str = str(ws.range("AD13").value)  # AD13
        ...
        self.__xlCustomerCapital: float = None  # H18
        self.__xlEstablishedMonth: str = ""  # I19
        self.__xlEstablishedYear: int = None  # O19
        self.__xlAccountClosingMonth: int = None  # M21
        self.__xlReturnOnEquity: float = None  # I20
